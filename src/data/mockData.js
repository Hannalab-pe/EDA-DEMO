  ...
  matriculas: [
    {
      ...
      estado: 'ACTIVO',
      montoMatricula: 300.00,
      montoMensualidad: 450.00,
      descuento: 0.00,
  ...
  tareas: [
    {
      ...
      descripcion: 'Actividad para reforzar el reconocimiento de números',
      gradoId: '1',
      aulaId: '1',
      docenteId: '2',
    ...
    {
      id: '2',
      titulo: 'Dibujar la familia',
      descripcion: 'Dibujo libre sobre los miembros de la familia',
      gradoId: '2',
      aulaId: '2',
      docenteId: '5',
    ...
    {
      id: '3',
      titulo: 'Recitar una poesía corta',
      descripcion: 'Memorizar y recitar una poesía de 4 versos',
      gradoId: '3',
      aulaId: '3',
      docenteId: '6',
      fechaCreacion: '2024-10-02',
      fechaVencimiento: '2024-10-08',
      estado: 'ACTIVO',
  ...
  planificaciones: [
    {
      ...
      descripcion: 'Actividades enfocadas en el aprendizaje de números del 1 al 20',
      gradoId: '1',
      docenteId: '2',
