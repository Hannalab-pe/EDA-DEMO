...
const generarPensionesFicticias = () => {
  const pensiones = [];
  const estudiantes = [
    { nombre: 'Carlos', apellido: 'Mendoza', documento: '12345678', apoderado: 'María Mendoza' },
    { nombre: 'Ana', apellido: 'García', documento: '23456789', apoderado: 'Juan García' },
    { nombre: 'Luis', apellido: 'Rodríguez', documento: '34567890', apoderado: 'Rosa Rodríguez' },
    { nombre: 'María', apellido: 'López', documento: '45678901', apoderado: 'Pedro López' },
    { nombre: 'Jorge', apellido: 'Martínez', documento: '56789012', apoderado: 'Carmen Martínez' },
    { nombre: 'Laura', apellido: 'Hernández', documento: '67890123', apoderado: 'Roberto Hernández' },
    { nombre: 'Diego', apellido: 'González', documento: '78901234', apoderado: 'Elena González' },
    { nombre: 'Sofía', apellido: 'Pérez', documento: '89012345', apoderado: 'Luis Pérez' },
    { nombre: 'Mateo', apellido: 'Sánchez', documento: '90123456', apoderado: 'Ana Sánchez' },
    { nombre: 'Valentina', apellido: 'Ramírez', documento: '01234567', apoderado: 'Carlos Ramírez' },
    { nombre: 'Lucas', apellido: 'Torres', documento: '11234567', apoderado: 'Lucía Torres' },
    { nombre: 'Isabella', apellido: 'Flores', documento: '21234567', apoderado: 'Miguel Flores' },
    { nombre: 'Sebastián', apellido: 'Rivera', documento: '31234567', apoderado: 'Patricia Rivera' },
    { nombre: 'Camila', apellido: 'Gómez', documento: '41234567', apoderado: 'Fernando Gómez' },
    { nombre: 'Nicolás', apellido: 'Díaz', documento: '51234567', apoderado: 'Sofía Díaz' },
  ];
  ...
  estudiantes.forEach((estudiante, idx) => {
    ...
    meses.forEach((mes, mesIdx) => {
      ...
      if (estado === 'VENCIDO') {
        ...
        mora = diasVencidos * 1.50; // S/ 1.50 por día
      }
      ...
      pensiones.push({
        ...
        metodoPago: fechaPago ? ['Efectivo', 'Transferencia', 'Tarjeta'][Math.floor(Math.random() * 3)] : null,
        observaciones: estado === 'VENCIDO' ? 'Pago atrasado' : (descuento > 0 ? 'Descuento por pronto pago' : null)
      });
    });
  });
...
const Pensiones = () => {
  ...
  useEffect(() => {
    ...
    toast.info('Modo Demostración', {
      description: 'Los datos mostrados son ficticios para propósitos de demostración.',
      duration: 3000,
    });
    ...
    const timer = setTimeout(() => {
      ...
      setLoading(false);
      console.log('✅ [DEMO] Pensiones Admin cargadas:', generarPensionesFicticias().length, 'registros');
    }, 800);
