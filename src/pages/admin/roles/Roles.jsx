...
import { Shield, ShieldPlus, RefreshCw } from "lucide-react";
...
const Roles = () => {
  ...
  const { roles, loading, createRol, refreshRoles } = useRoles();
  ...
  return (
    <div className="space-y-6">
      ...
      <TablaRoles roles={roles} loading={loading} onAdd={handleAdd} />
